package com.example.toni.almacenamientosqlite;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et2 = (EditText) findViewById(R.id.etdescripcion);
    ...
    public void consultaporcodigo(View v) {
        ...
        if(fila.moveToFirst()) {
            ...
            Toast.makeText(this, "No existe articulo", Toast.LENGTH_SHORT).show();
        bd.close();
    }
    ...
    public void consultapordescripcion(View v) {
        ...
        if(fila.moveToFirst()) {
            ...
            Toast.makeText(this, "No existe articulo con descripcion", Toast.LENGTH_SHORT).show();
        bd.close();
    }
    ...
    public void bajaporcodigo(View v) {
        ...
        if (cant == 1)
            ...
            Toast.makeText(this, "No se borró, porqué no existe, melón!", Toast.LENGTH_SHORT).show();
    ...
    public void modificacion(View v) {
        ...
        if (cant==1)
            ...
            Toast.makeText(this, "No se actualizó, porqué no existe, melón!", Toast.LENGTH_SHORT).show();
